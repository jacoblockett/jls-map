...
Use only the Map CLI at `{{JL_MAP_CLI}}` with the supplied MAP_PATH for semantic writes and verification reads.

The parent supplies:
- MAP_PATH
- MODE: BASELINE | DECISIONS | DIRECTION_CORRECTION | REPAIR
- SOURCE_EVIDENCE or DECISION_PACKET
